...
public class EachFragmentSecond extends Fragment {
...
//                URL url = new URL("https://affiliate-api.flipkart.net/affiliate/offers/v1/all/json");
                URL url = new URL("http://couponkhajana.com/android/Coupons/category_each_api2.php?para1=" + allHeadings[1]+ "&para2=" + allHeadings[2] + "&para3=" + allHeadings[3] + "&para4=" + allHeadings[4] + "&present=" + presentHeading );
