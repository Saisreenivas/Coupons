...
//                        session.createLoginSession("Android Hive", "anroidhive@gmail.com");
                        ...
                        new GetDataForContent(getParent(), progressBar ,txtUsername, password).execute();
    ...
    private class GetDataForContent extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                ...
                URL url = new URL("http://192.168.1.105/Coupons/sign_in.php?username=" + email +"&password=" + password);
...
//                                progress.setVisibility(GONE);
                                ...
                                session.createLoginSession(email, password, referral_code);
...
//                intent.putExtra("wallet_balance", result + " ");
                ...
                Toast.makeText(PasswordActivity.this, "Wallet Balance: " + result, Toast.LENGTH_LONG).show();
                startActivity(intent);
                finish();
